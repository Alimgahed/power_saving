              ...
              Expanded(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'ابحث عن اسم المحطة، التقنية، السنة، أو الفرع...',
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        'إجمالي النتائج: ${controller.totalItems} فاتورة',
              ...
              children: [
                    ...
                    return FittedBox(
                      ...
                      child: ConstrainedBox(
                        ...
                        child: DataTable(
                          ...
                          columnSpacing: 30,
                          columns: const [
                            DataColumn(label: Text('الفرع', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.primaryDark))),
                          ...
                          rows: filteredBills.map((bill) {
                            return DataRow(
                              cells: [
                                DataCell(Text(bill.branch ?? '-', style: const TextStyle(fontWeight: FontWeight.w600))),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ElevatedButton.icon(
                        onPressed: controller.hasPrev ? controller.previousPage : null,
                      ...
                      Text(
                        'صفحة ${controller.currentPage} من ${controller.totalPages}',
